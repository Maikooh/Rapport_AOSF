...
```{r dendro2024, echo=FALSE, fig.cap="Dendrogramme de la classification ascendante hiérarchique (méthode de Ward), année 2024.", out.width='100%'}
...
```{r wss2024, echo=FALSE, fig.cap="Méthode du coude (WSS) pour le choix du nombre de clusters, année 2024.", out.width='85%'}
...
```{r silhouette2024, echo=FALSE, fig.cap="Indice moyen de silhouette selon le nombre de clusters, année 2024.", out.width='85%'}
...
```{r km2024, echo=FALSE, fig.cap="Projection des clusters k-means (k = 4) sur le plan ACP, année 2024.", out.width='100%'}
...
```{r cah2024, echo=FALSE, fig.cap="Projection des classes issues de la CAH (k = 4) sur le plan ACP, année 2024.", out.width='100%'}
...
```{r profils2024, echo=FALSE, fig.cap="Profils des clusters : moyennes standardisées (z-scores) des variables, année 2024.", out.width='100%'}
